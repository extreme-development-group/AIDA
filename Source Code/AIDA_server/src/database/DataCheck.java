...
public final class DataCheck {
     ...
     *              查询结果集失败抛出该异常
     */
    public Vector<UserInfo.FriendsOrGroups> getUserFriends(String userId, DataBaseConnection dataCon) {
        Vector<UserInfo.FriendsOrGroups> friends = new Vector<UserInfo.FriendsOrGroups>();
        ...
        try {
            while (resultSet.next()) {
                ...
                friends.add(new UserInfo.FriendsOrGroups(fId, fName, fAvatar, fTrade, fStatus));
            }
            resultSet.close();
        } catch (SQLException e) {
     ...
     *              查询结果集失败抛出该异常
     */
    public Vector<UserInfo.FriendsOrGroups> getUserGroups(String userId, DataBaseConnection dataCon) {
        Vector<UserInfo.FriendsOrGroups> groups = new Vector<UserInfo.FriendsOrGroups>();
        ...
        try {
            while (resultSet.next()) {
                ...
                groups.add(new UserInfo.FriendsOrGroups(gId, gName, gAvatar, gTrades, gStatus));
            }
            resultSet.close();
        } catch (SQLException e) {
    ...
    public UserInfo getUserInfo(String userId) {
        ...
        Vector<UserInfo.FriendsOrGroups> friends;
        Vector<UserInfo.FriendsOrGroups> groups;
